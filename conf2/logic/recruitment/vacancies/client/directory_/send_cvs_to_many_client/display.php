...
class recruitment_vacancies_client_directory__send_cvs_to_many_client_display extends NxPage
{
	function recruitment_vacancies_client_directory__send_cvs_to_many_client_display($props,&$parentDesc,$aspect)
	{
	...
	function run()
	{
					...
					$this->runView('/recruitment/vacancies/client/directory__send_cvs_to_client',array(
						'fmethod' => 'toForm',
