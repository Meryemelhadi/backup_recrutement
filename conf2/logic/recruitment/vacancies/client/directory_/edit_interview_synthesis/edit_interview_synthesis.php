...
class recruitment_vacancies_client_directory__edit_interview_synthesis_edit_interview_synthesis extends NxPage
{
	function recruitment_vacancies_client_directory__edit_interview_synthesis_edit_interview_synthesis($props,&$parentDesc,$aspect)
	{
	...
	function run()
	{
					...
					$this->runView('/recruitment/vacancies/client/directory__interview_synthesis_edit',array(
						'fmethod' => 'toHTML',
