...
class recruitment_vacancies_client_directory__edit_interview_process_edit_interview_process extends NxPage
{
	function recruitment_vacancies_client_directory__edit_interview_process_edit_interview_process($props,&$parentDesc,$aspect)
	{
	...
	function run()
	{
					...
					$this->putRecord(
						$this->getRecord('rct_interview.edit_to_candidate@recruitment','page.record','post',false,null,null),'rct_interview.edit@recruitment','update','db','Object',null);
