...
<br/>
					...
					&nbsp;{string:"action_candidate_vacancy"}
						...
						{if:!%property:from_new_cvt%}
														<li>
															<a href="javascript:void(0);" onclick="document.location.href='{var:PORTAL_URL_PREFIX}/recruitment/vacancies/admin/void-{field.object:oid}/directory.php?nxo=edit&mode=page&oid={field.object:oid}'">
																<span class="glyphicon glyphicon-share-alt" aria-hidden="true"></span>&nbsp;&nbsp;{string:"go_to_vacancy"}</a>
														</li>{/if}
...
//]]>
															...
															<fieldset id="group_1" class="field-group-bs">
																...
																<div id="field_{field.name}" class="form-group form-group-bs field-type-{field.type} {if:field.is_last} last_field{/if}">
																	...
																	<span class="required-field">*</span>{/if} :
																			...
																			<div class="form-control-bs" id="{field.name}-control">{field:category_oid}</div></div></div>
															</fieldset>
						...
						{get_field:available_from}{/get_field}
																				...
																				<div class="form-control-bs control2" id="{field.name}-control">{field:available_from}</div></div></div>{get_field:salary_min}{/get_field}
																<div id="field_{field.name}" class="form-group form-group-double form-group-bs field-type-{field.type} {if:field.is_last} last_field{/if}">
																				<div class="control-label-wrapper-bs">
						...
						{get_field:salary_max}{/get_field}
																				...
																				<div class="form-control-bs control2" id="{field.name}-control">{field:salary_max}</div></div></div>{get_field:profile}{/get_field}
																<div id="field_{field.name}" class="form-group form-group-bs field-type-{field.type} {if:field.is_last} last_field{/if}">
																				<div class="control-label-wrapper-bs">
																					<label for="{field.name}" class="control-label-bs control-label">{field.label:profile}{if:field.isRequired}
																	<span class="required-field">*</span>{/if} :
																					</label></div>
																			<div class="form-control-bs" id="{field.name}-control">{field:profile}</div></div>{get_field:years_of_practice}{/get_field}
																<div id="field_{field.name}" class="form-group form-group-bs field-type-{field.type} {if:field.is_last} last_field{/if}">
																				<div class="control-label-wrapper-bs">
																...
																<div id="field_{field.name}" class="form-group form-group-bs field-type-{field.type} {if:field.is_last} last_field{/if}">
																	...
																	<span class="required-field">*</span>{/if} :
																			...
																			<div class="form-control-bs" id="{field.name}-control">{field:studies_level}</div></div>{get_field:archive_state}{/get_field}
																<div id="field_{field.name}" class="form-group form-group-bs field-type-{field.type} {if:field.is_last} last_field{/if}">
																				<div class="control-label-wrapper-bs">
