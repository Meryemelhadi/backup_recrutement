		...
		<div class="pm-page-title-wrapper">
			<div class="pm-page-title-inner-wrapper">
				<div id="page_title" class="pm-title">
					<div class="title_tb" style="float:right"></div></div></div></div><?php 
...
<?php $_nx_content_stack[]="buttons";	ob_start(); ?>
	...
	<button type="button" class="btn btn-default button_back" onclick="document.location.href='{=previous_operation.url}&tab=recruitement_card'"><span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span>&nbsp;&nbsp;
	...
	<div class="btn-group button_bs_right" role="group"><button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><span class="glyphicon glyphicon-cog"></span></button><ul class="dropdown-menu" style="right:0px ; left:initial;"><li><a href="{=meeting_rooms.url}"><span class="glyphicon glyphicon-object-align-bottom" aria-hidden="true"></span>&nbsp;&nbsp;{string:"meeting_rooms"}</a></li><li><a href="{=email_samples.url}"><span class="glyphicon glyphicon-envelope" aria-hidden="true"></span>&nbsp;&nbsp;{string:"email_samples"}</a></li><li><a href="{=attached_files.url}"><span class="glyphicon glyphicon-duplicate" aria-hidden="true"></span>&nbsp;&nbsp;{string:"attached_files_title"}</a></li></ul></div>
	{/if}
	<span class="pm-button-sep"></span><button type="button" class="btn btn-default right submit_marge" onclick="PMFormSubmit.submit(this, dlg_waitConfig, dlg_successConfig, dlg_failureConfig); this.blur(); return false;"><span class="glyphicon glyphicon-floppy-save" aria-hidden="true"></span>&nbsp;&nbsp;
		{string:"submit_email"}
	</button>
...
{record:candidate.record}
	<?php $_nx_content_stack[]="candidate_etat";	ob_start(); ?>
		<div id="field_etat_oid" class="form-group form-group-bs field-type-text_choice "><div class="control-label-wrapper-bs"><label for="etat_oid" class="control-label-bs control-label">{field.label:etat_oid} :</label></div><div class="form-control-bs" id="etat_oid-control">
				{field.form:etat_oid}
			</div></div>
	<?php $this->setProperty(array_pop($_nx_content_stack),ob_get_contents());ob_end_clean();?>		
...
//]]>
		...
		<?php $_nx_content_stack[]="tabs_src";	ob_start(); ?>
			...
			<div style="{var:displayMode}" id="planification_div" class="tab panel">
										...
										{get_field:candidate_oid}{/get_field}
																<div id="field_{field.name}" class="form-group form-group-bs field-type-{field.type} {if:field.is_last} last_field{/if}">
																	...
																	<span class="required-field">*</span>{/if} :
																			...
																			<div class="form-control-bs" id="{field.name}-control">{field:candidate_oid}</div></div>
										{/if}
										
										{get_field:interview_by_oid}{/get_field}
																<div id="field_{field.name}" class="form-group form-group-bs field-type-{field.type} {if:field.is_last} last_field{/if}">
																				<div class="control-label-wrapper-bs">
															...
															<fieldset id="group_2" class="field-group-bs">
																...
																<div id="field_{field.name}" class="form-group form-group-bs field-type-{field.type} {if:field.is_last} last_field{/if}">
																	...
																	<span class="required-field">*</span>{/if} :
																			...
																			<div class="form-control-bs" id="{field.name}-control">{field:interview_feedback}</div></div>{get_field:interview_etat}{/get_field}
																<div id="field_{field.name}" class="form-group form-group-bs field-type-{field.type} {if:field.is_last} last_field{/if}">
																				<div class="control-label-wrapper-bs">
