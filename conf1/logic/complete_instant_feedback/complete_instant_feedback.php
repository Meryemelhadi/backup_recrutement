...
class complete_instant_feedback_complete_instant_feedback extends NxPage
{
	function complete_instant_feedback_complete_instant_feedback($props,&$parentDesc,$aspect)
	{
	...
	function run()
	{
							...
							$this->runView('_feedback_write',array(
								'fmethod' => 'toHTML',
