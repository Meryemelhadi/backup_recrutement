...
class edit_interview_synthesis_edit_interview_synthesis extends NxPage
{
	function edit_interview_synthesis_edit_interview_synthesis($props,&$parentDesc,$aspect)
	{
	...
	function run()
	{
							...
							$this->runView('_interview_synthesis_edit',array(
								'fmethod' => 'toHTML',
