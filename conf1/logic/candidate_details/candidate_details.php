...
class candidate_details_candidate_details extends NxPage
{
	function candidate_details_candidate_details($props,&$parentDesc,$aspect)
	{
	...
	function run()
	{
							...
							$this->runView('_candidate_details',array(
								'fmethod' => 'toHTML',
