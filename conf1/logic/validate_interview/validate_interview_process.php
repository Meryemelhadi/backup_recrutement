...
class validate_interview_validate_interview_process extends NxPage
{
	function validate_interview_validate_interview_process($props,&$parentDesc,$aspect)
	{
