...
class add_interview_synthesis_process_add_interview_synthesis_process extends NxPage
{
	function add_interview_synthesis_process_add_interview_synthesis_process($props,&$parentDesc,$aspect)
	{
