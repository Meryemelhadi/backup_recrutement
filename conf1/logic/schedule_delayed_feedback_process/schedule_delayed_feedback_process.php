...
class schedule_delayed_feedback_process_schedule_delayed_feedback_process extends NxPage
{
	function schedule_delayed_feedback_process_schedule_delayed_feedback_process($props,&$parentDesc,$aspect)
	{
