...
class edit_interview_edit_interview extends NxPage
{
	function edit_interview_edit_interview($props,&$parentDesc,$aspect)
	{
	...
	function run()
	{
							...
							$this->getRecords('','','db',false,null,null);
								...
								{
									$this->runView('_my_interview_edit',array(
										'fmethod' => 'toHTML',

										),null);
								}
								else {
									$this->runView('_interview_edit',array(
										'fmethod' => 'toHTML',
