...
class schedule_warning_schedule_warning extends NxPage
{
	function schedule_warning_schedule_warning($props,&$parentDesc,$aspect)
	{
	...
	function run()
	{
							...
							$this->runView('_warning_schedule',array(
								'fmethod' => 'toHTML',
