...
class schedule_instant_feedback_process_schedule_instant_feedback_process extends NxPage
{
	function schedule_instant_feedback_process_schedule_instant_feedback_process($props,&$parentDesc,$aspect)
	{
