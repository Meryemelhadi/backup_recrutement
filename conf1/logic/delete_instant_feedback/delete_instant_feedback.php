...
class delete_instant_feedback_delete_instant_feedback extends NxPage
{
	function delete_instant_feedback_delete_instant_feedback($props,&$parentDesc,$aspect)
	{
