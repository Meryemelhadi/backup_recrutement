...
class add_interview_process_add_interview_process extends NxPage
{
	function add_interview_process_add_interview_process($props,&$parentDesc,$aspect)
	{
