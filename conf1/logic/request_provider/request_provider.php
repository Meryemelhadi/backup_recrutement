...
class request_provider_request_provider extends NxPage
{
	function request_provider_request_provider($props,&$parentDesc,$aspect)
	{
	...
	function run()
	{
							...
							$this->runView('_provider_add',array(
								'fmethod' => 'toHTML',
