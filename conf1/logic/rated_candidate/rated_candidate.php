...
class rated_candidate_rated_candidate extends NxPage
{
	function rated_candidate_rated_candidate($props,&$parentDesc,$aspect)
	{
	...
	function run()
	{
							...
							$this->runView('_rated_candidate',array(
								'fmethod' => 'toHTML',
