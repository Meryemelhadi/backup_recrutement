...
class delete_delayed_feedback_delete_delayed_feedback extends NxPage
{
	function delete_delayed_feedback_delete_delayed_feedback($props,&$parentDesc,$aspect)
	{
