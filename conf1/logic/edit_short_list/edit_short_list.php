...
class edit_short_list_edit_short_list extends NxPage
{
	function edit_short_list_edit_short_list($props,&$parentDesc,$aspect)
	{
	...
	function run()
	{
							...
							$this->runView('_short_list_edit',array(
								'fmethod' => 'toHTML',
