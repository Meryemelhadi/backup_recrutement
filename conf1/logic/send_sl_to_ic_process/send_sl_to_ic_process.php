...
class send_sl_to_ic_process_send_sl_to_ic_process extends NxPage
{
	function send_sl_to_ic_process_send_sl_to_ic_process($props,&$parentDesc,$aspect)
	{
