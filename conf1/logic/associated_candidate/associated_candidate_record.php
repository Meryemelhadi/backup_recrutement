...
class associated_candidate_associated_candidate_record extends NxPage
{
	function associated_candidate_associated_candidate_record($props,&$parentDesc,$aspect)
	{
