...
class candidates_search_results_candidates_search_results extends NxPage
{
	function candidates_search_results_candidates_search_results($props,&$parentDesc,$aspect)
	{
	...
	function run()
	{
							...
							$this->runView('_candidates_search_results',array(
								'fmethod' => 'toHTML',
