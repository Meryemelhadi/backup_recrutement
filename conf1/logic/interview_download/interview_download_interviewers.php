...
class interview_download_interview_download_interviewers extends NxPage
{
	function interview_download_interview_download_interviewers($props,&$parentDesc,$aspect)
	{
