...
class recruitment_candidates_directory__relevance_display extends NxPage
{
	function recruitment_candidates_directory__relevance_display($props,&$parentDesc,$aspect)
	{
	...
	function run()
	{
					...
					$this->runView('/recruitment/candidates/directory__relevance',array(
						'fmethod' => 'toHTML',
