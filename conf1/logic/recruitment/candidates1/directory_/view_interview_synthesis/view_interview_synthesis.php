...
class recruitment_candidates_directory__view_interview_synthesis_view_interview_synthesis extends NxPage
{
	function recruitment_candidates_directory__view_interview_synthesis_view_interview_synthesis($props,&$parentDesc,$aspect)
	{
	...
	function run()
	{
					...
					$this->runView('/recruitment/candidates/directory__interview_synthesis_view',array(
						'fmethod' => 'toHTML',
