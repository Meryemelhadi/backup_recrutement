...
class recruitment_candidates_directory__add_interview_process_add_interview_process extends NxPage
{
	function recruitment_candidates_directory__add_interview_process_add_interview_process($props,&$parentDesc,$aspect)
	{
	...
	function run()
	{
				...
				$lastOids = array();
					...
					foreach($candidates_oids as $i=>$value)
					{
						...
						$this->putRecord(
							$this->getRecord('rct_interview.add_to_candidate@recruitment','page.records','post',false,null,null),'rct_interview.add_to_candidate@recruitment','insert','db','Object',null);
						$lastOid=
