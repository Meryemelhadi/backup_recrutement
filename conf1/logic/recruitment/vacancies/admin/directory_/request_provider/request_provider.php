...
class recruitment_vacancies_admin_directory__request_provider_request_provider extends NxPage
{
	function recruitment_vacancies_admin_directory__request_provider_request_provider($props,&$parentDesc,$aspect)
	{
	...
	function run()
	{
					...
					$this->runView('/recruitment/vacancies/admin/directory__provider_add',array(
						'fmethod' => 'toHTML',
