...
class recruitment_vacancies_admin_directory__edit_short_list_edit_short_list_process extends NxPage
{
	function recruitment_vacancies_admin_directory__edit_short_list_edit_short_list_process($props,&$parentDesc,$aspect)
	{
