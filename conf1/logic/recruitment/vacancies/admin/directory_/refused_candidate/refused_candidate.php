...
class recruitment_vacancies_admin_directory__refused_candidate_refused_candidate extends NxPage
{
	function recruitment_vacancies_admin_directory__refused_candidate_refused_candidate($props,&$parentDesc,$aspect)
	{
	...
	function run()
	{
					...
					$this->runView('/recruitment/vacancies/admin/directory__refused_candidate',array(
						'fmethod' => 'toHTML',
