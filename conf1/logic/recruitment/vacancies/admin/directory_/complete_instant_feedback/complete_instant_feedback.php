...
class recruitment_vacancies_admin_directory__complete_instant_feedback_complete_instant_feedback extends NxPage
{
	function recruitment_vacancies_admin_directory__complete_instant_feedback_complete_instant_feedback($props,&$parentDesc,$aspect)
	{
	...
	function run()
	{
					...
					$this->runView('/recruitment/vacancies/admin/directory__feedback_write',array(
						'fmethod' => 'toHTML',
