...
class recruitment_vacancies_admin_directory__candidates_candidates extends NxPage
{
	function recruitment_vacancies_admin_directory__candidates_candidates($props,&$parentDesc,$aspect)
	{
