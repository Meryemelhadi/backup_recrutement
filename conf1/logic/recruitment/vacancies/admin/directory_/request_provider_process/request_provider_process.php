...
class recruitment_vacancies_admin_directory__request_provider_process_request_provider_process extends NxPage
{
	function recruitment_vacancies_admin_directory__request_provider_process_request_provider_process($props,&$parentDesc,$aspect)
	{
