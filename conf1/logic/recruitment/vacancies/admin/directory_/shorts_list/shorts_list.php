...
class recruitment_vacancies_admin_directory__shorts_list_shorts_list extends NxPage
{
	function recruitment_vacancies_admin_directory__shorts_list_shorts_list($props,&$parentDesc,$aspect)
	{
	...
	function run()
	{
					...
					$this->runView('/recruitment/vacancies/admin/directory__shorts_list',array(
						'fmethod' => 'toHTML',
