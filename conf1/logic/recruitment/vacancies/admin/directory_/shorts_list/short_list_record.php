...
class recruitment_vacancies_admin_directory__shorts_list_short_list_record extends NxPage
{
	function recruitment_vacancies_admin_directory__shorts_list_short_list_record($props,&$parentDesc,$aspect)
	{
