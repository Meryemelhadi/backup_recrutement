...
class recruitment_vacancies_admin_directory__interview_download_interview_download_interviewers extends NxPage
{
	function recruitment_vacancies_admin_directory__interview_download_interview_download_interviewers($props,&$parentDesc,$aspect)
	{
