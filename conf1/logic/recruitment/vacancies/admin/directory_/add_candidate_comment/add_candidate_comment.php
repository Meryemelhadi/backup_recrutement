...
class recruitment_vacancies_admin_directory__add_candidate_comment_add_candidate_comment extends NxPage
{
	function recruitment_vacancies_admin_directory__add_candidate_comment_add_candidate_comment($props,&$parentDesc,$aspect)
	{
