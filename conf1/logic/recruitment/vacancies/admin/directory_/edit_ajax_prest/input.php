...
class recruitment_vacancies_admin_directory__edit_ajax_prest_input extends NxPage
{
	function recruitment_vacancies_admin_directory__edit_ajax_prest_input($props,&$parentDesc,$aspect)
	{
	...
	function run()
	{
					...
					$this->runView('/recruitment/vacancies/admin/directory__edit_prest',array(
						'fmethod' => 'toHTML',
