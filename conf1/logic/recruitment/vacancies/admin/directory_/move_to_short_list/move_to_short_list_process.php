...
class recruitment_vacancies_admin_directory__move_to_short_list_move_to_short_list_process extends NxPage
{
	function recruitment_vacancies_admin_directory__move_to_short_list_move_to_short_list_process($props,&$parentDesc,$aspect)
	{
	...
	function run()
	{
					...
					$insered_candidates=
						(($__o=$this->getHandler('lib.recruitment.short_lists.services.directory','')) ? $__o->moveAssociations($this->getProperty("candidate_oid",""),$this->getProperty("short_list_oid","")) : null);
