...
class recruitment_vacancies_admin_directory__ics_export_ics_export extends NxPage
{
	function recruitment_vacancies_admin_directory__ics_export_ics_export($props,&$parentDesc,$aspect)
	{
