...
class recruitment_vacancies_admin_directory__edit_interview_process_edit_interview_process extends NxPage
{
	function recruitment_vacancies_admin_directory__edit_interview_process_edit_interview_process($props,&$parentDesc,$aspect)
	{
