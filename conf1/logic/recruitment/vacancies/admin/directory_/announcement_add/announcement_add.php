...
class recruitment_vacancies_admin_directory__announcement_add_announcement_add extends NxPage
{
	function recruitment_vacancies_admin_directory__announcement_add_announcement_add($props,&$parentDesc,$aspect)
	{
	...
	function run()
	{
					...
					$this->setProperty("vacancy_oid",(isset($_REQUEST["oid"])?$_REQUEST["oid"]:""));
					$this->getRecord('journal.add@recruitment','page.record','empty',false,null,null);
