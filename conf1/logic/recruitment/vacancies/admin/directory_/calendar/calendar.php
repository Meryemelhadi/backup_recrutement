...
class recruitment_vacancies_admin_directory__calendar_calendar extends NxPage
{
	function recruitment_vacancies_admin_directory__calendar_calendar($props,&$parentDesc,$aspect)
	{
	...
	function run()
	{
					...
					$this->runView('/recruitment/vacancies/admin/directory__calendar',array(
						'fmethod' => 'toHTML',
