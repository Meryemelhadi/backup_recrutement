...
class recruitment_vacancies_admin_directory__recruitment_providers_recruitment_providers extends NxPage
{
	function recruitment_vacancies_admin_directory__recruitment_providers_recruitment_providers($props,&$parentDesc,$aspect)
	{
	...
	function run()
	{
					...
					$this->runView('/recruitment/vacancies/admin/directory__recruitment_providers',array(
						'fmethod' => 'toHTML',
