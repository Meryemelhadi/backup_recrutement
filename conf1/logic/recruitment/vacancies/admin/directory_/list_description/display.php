...
class recruitment_vacancies_admin_directory__list_description_display extends NxPage
{
	function recruitment_vacancies_admin_directory__list_description_display($props,&$parentDesc,$aspect)
	{
	...
	function run()
	{
					...
					$this->runView('/recruitment/vacancies/admin/directory__list_description_ajax',array(
						'fmethod' => 'toHTML',
