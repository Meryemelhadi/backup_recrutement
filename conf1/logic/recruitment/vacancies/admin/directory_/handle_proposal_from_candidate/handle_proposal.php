...
class recruitment_vacancies_admin_directory__handle_proposal_from_candidate_handle_proposal extends NxPage
{
	function recruitment_vacancies_admin_directory__handle_proposal_from_candidate_handle_proposal($props,&$parentDesc,$aspect)
	{
