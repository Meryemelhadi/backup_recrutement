...
class recruitment_vacancies_admin_directory__associated_candidate_associated_candidate_record extends NxPage
{
	function recruitment_vacancies_admin_directory__associated_candidate_associated_candidate_record($props,&$parentDesc,$aspect)
	{
