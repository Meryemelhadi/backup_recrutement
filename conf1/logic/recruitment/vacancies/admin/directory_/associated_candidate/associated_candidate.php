...
class recruitment_vacancies_admin_directory__associated_candidate_associated_candidate extends NxPage
{
	function recruitment_vacancies_admin_directory__associated_candidate_associated_candidate($props,&$parentDesc,$aspect)
	{
