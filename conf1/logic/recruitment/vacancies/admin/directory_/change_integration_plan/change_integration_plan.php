...
class recruitment_vacancies_admin_directory__change_integration_plan_change_integration_plan extends NxPage
{
	function recruitment_vacancies_admin_directory__change_integration_plan_change_integration_plan($props,&$parentDesc,$aspect)
	{
