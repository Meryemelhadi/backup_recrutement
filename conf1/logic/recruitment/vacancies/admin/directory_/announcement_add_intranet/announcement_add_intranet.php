...
class recruitment_vacancies_admin_directory__announcement_add_intranet_announcement_add_intranet extends NxPage
{
	function recruitment_vacancies_admin_directory__announcement_add_intranet_announcement_add_intranet($props,&$parentDesc,$aspect)
	{
	...
	function run()
	{
					...
					$this->runView('/recruitment/vacancies/admin/directory__announcement_add',array(
						'fmethod' => 'toHTML',
