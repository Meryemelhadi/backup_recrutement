...
class recruitment_vacancies_admin_directory__announcement_add_intranet_process extends NxPage
{
	function recruitment_vacancies_admin_directory__announcement_add_intranet_process($props,&$parentDesc,$aspect)
	{
