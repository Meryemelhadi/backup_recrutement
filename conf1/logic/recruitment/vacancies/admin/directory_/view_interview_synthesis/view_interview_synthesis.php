...
class recruitment_vacancies_admin_directory__view_interview_synthesis_view_interview_synthesis extends NxPage
{
	function recruitment_vacancies_admin_directory__view_interview_synthesis_view_interview_synthesis($props,&$parentDesc,$aspect)
	{
	...
	function run()
	{
					...
					$this->runView('/recruitment/vacancies/admin/directory__interview_synthesis_view',array(
						'fmethod' => 'toHTML',
