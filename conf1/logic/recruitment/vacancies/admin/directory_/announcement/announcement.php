...
class recruitment_vacancies_admin_directory__announcement_announcement extends NxPage
{
	function recruitment_vacancies_admin_directory__announcement_announcement($props,&$parentDesc,$aspect)
	{
	...
	function run()
	{
					...
					$this->runView('/recruitment/vacancies/admin/directory__announcement',array(
						'fmethod' => 'toHTML',
