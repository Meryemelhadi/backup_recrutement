...
class recruitment_vacancies_admin_directory__email_download_email_download extends NxPage
{
	function recruitment_vacancies_admin_directory__email_download_email_download($props,&$parentDesc,$aspect)
	{
