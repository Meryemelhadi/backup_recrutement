...
class recruitment_vacancies_admin_directory__change_hire_date_process extends NxPage
{
	function recruitment_vacancies_admin_directory__change_hire_date_process($props,&$parentDesc,$aspect)
	{
