...
class recruitment_vacancies_manager_directory__details_description_input extends NxPage
{
	function recruitment_vacancies_manager_directory__details_description_input($props,&$parentDesc,$aspect)
	{
	...
	function run()
	{
					...
					$this->runView('/recruitment/vacancies/manager/directory__show',array(
						'fmethod' => 'toHTML',
