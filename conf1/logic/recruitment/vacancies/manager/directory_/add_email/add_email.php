...
class recruitment_vacancies_manager_directory__add_email_add_email extends NxPage
{
	function recruitment_vacancies_manager_directory__add_email_add_email($props,&$parentDesc,$aspect)
	{
	...
	function run()
	{
					...
					$this->runView('/recruitment/vacancies/manager/directory__email_add',array(
						'fmethod' => 'toHTML',
