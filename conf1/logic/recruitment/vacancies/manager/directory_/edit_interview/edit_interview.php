...
class recruitment_vacancies_manager_directory__edit_interview_edit_interview extends NxPage
{
	function recruitment_vacancies_manager_directory__edit_interview_edit_interview($props,&$parentDesc,$aspect)
	{
	...
	function run()
	{
					...
					$this->getRecords('rct_interview.by_user_day_now','interviews.records','db',false,null,null);
						...
						{
							$this->runView('/recruitment/vacancies/manager/directory__my_interview_edit',array(
								'fmethod' => 'toHTML',

								),null);
						}
						else {
							$this->runView('/recruitment/vacancies/manager/directory__interview_edit',array(
								'fmethod' => 'toHTML',
