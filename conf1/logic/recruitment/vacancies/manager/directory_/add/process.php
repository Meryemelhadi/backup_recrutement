...
class recruitment_vacancies_manager_directory__add_process extends NxPage
{
	function recruitment_vacancies_manager_directory__add_process($props,&$parentDesc,$aspect)
	{
	...
	function run()
	{
					...
					$this->runView('/recruitment/vacancies/manager/directory__redirect',array(
						'fmethod' => 'toHTML',
