...
class recruitment_vacancies_manager_directory__edit_warning_edit_warning extends NxPage
{
	function recruitment_vacancies_manager_directory__edit_warning_edit_warning($props,&$parentDesc,$aspect)
	{
	...
	function run()
	{
					...
					$this->setProperty('submit.url',$_SERVER["PHP_SELF"].'?nxo=edit_warning_process#&amp;nxs=');
					$this->getRecord('rct_warning.edit@recruitment','page.record','db',false,null,null);
					$this->runView('/recruitment/vacancies/manager/directory__warning_edit',array(
						'fmethod' => 'toHTML',
