...
class recruitment_vacancies_manager_directory__send_sl_to_ic_send_sl_to_ic extends NxPage
{
	function recruitment_vacancies_manager_directory__send_sl_to_ic_send_sl_to_ic($props,&$parentDesc,$aspect)
	{
	...
	function run()
	{
					...
					$this->runView('/recruitment/vacancies/manager/directory__send_sl_to_ic',array(
						'fmethod' => 'toHTML',
