...
class recruitment_vacancies_manager_directory__candidates_search_results_candidates_search_results extends NxPage
{
	function recruitment_vacancies_manager_directory__candidates_search_results_candidates_search_results($props,&$parentDesc,$aspect)
	{
	...
	function run()
	{
					...
					$this->runView('/recruitment/vacancies/manager/directory__candidates_search_results',array(
						'fmethod' => 'toHTML',
