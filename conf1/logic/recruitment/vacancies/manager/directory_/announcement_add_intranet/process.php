...
class recruitment_vacancies_manager_directory__announcement_add_intranet_process extends NxPage
{
	function recruitment_vacancies_manager_directory__announcement_add_intranet_process($props,&$parentDesc,$aspect)
	{
	...
	function run()
	{
					...
					$article=
						$this->getRecord('journal.add_intranet@recruitment','page.record','post',false,null,null);
					$this->putRecord($article,'journal.add_intranet@recruitment','insert','db','Object',null);
