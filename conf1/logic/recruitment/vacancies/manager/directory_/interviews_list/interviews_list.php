...
class recruitment_vacancies_manager_directory__interviews_list_interviews_list extends NxPage
{
	function recruitment_vacancies_manager_directory__interviews_list_interviews_list($props,&$parentDesc,$aspect)
	{
