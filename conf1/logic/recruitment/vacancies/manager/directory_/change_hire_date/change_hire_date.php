...
class recruitment_vacancies_manager_directory__change_hire_date_change_hire_date extends NxPage
{
	function recruitment_vacancies_manager_directory__change_hire_date_change_hire_date($props,&$parentDesc,$aspect)
	{
