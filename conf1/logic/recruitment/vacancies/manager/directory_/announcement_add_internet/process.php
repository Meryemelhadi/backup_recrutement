...
class recruitment_vacancies_manager_directory__announcement_add_internet_process extends NxPage
{
	function recruitment_vacancies_manager_directory__announcement_add_internet_process($props,&$parentDesc,$aspect)
	{
