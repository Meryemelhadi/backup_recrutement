...
class recruitment_vacancies_manager_directory__validate_process extends NxPage
{
	function recruitment_vacancies_manager_directory__validate_process($props,&$parentDesc,$aspect)
	{
