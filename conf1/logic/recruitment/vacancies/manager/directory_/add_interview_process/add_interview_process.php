...
class recruitment_vacancies_manager_directory__add_interview_process_add_interview_process extends NxPage
{
	function recruitment_vacancies_manager_directory__add_interview_process_add_interview_process($props,&$parentDesc,$aspect)
	{
