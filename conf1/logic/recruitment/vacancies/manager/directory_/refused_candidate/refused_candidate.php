...
class recruitment_vacancies_manager_directory__refused_candidate_refused_candidate extends NxPage
{
	function recruitment_vacancies_manager_directory__refused_candidate_refused_candidate($props,&$parentDesc,$aspect)
	{
	...
	function run()
	{
					...
					$this->setProperty('candidate_record.url',$_SERVER["PHP_SELF"].'?nxo='.$this->getProperty("app.operation","").'&amp;nxs=refused_record&amp;vacancy_oid='.$this->getProperty("vacancy_oid",""));
					...
					$this->setProperty('search.url',$_SERVER["PHP_SELF"].'?nxo=refused_candidate&amp;nxs=&amp;vacancy_oid='.$this->getProperty("vacancy_oid","").'&amp;oid='.$this->getProperty("vacancy_oid",""));
					...
					$this->getRecords('handler:recruitment.candidates.refused@recruitment','candidates_refused.records','db',false,$searchData,null);
					$this->runView('/recruitment/vacancies/manager/directory__refused_candidate',array(
						'fmethod' => 'toHTML',
