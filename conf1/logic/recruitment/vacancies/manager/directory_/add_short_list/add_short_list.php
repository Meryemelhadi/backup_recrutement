...
class recruitment_vacancies_manager_directory__add_short_list_add_short_list extends NxPage
{
	function recruitment_vacancies_manager_directory__add_short_list_add_short_list($props,&$parentDesc,$aspect)
	{
	...
	function run()
	{
					...
					$this->runView('/recruitment/vacancies/manager/directory__short_list_add',array(
						'fmethod' => 'toHTML',
