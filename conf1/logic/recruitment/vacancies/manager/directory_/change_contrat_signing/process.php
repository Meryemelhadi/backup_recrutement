...
class recruitment_vacancies_manager_directory__change_contrat_signing_process extends NxPage
{
	function recruitment_vacancies_manager_directory__change_contrat_signing_process($props,&$parentDesc,$aspect)
	{
