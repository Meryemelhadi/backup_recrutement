...
class recruitment_vacancies_manager_directory__delete_sl_delete_sl extends NxPage
{
	function recruitment_vacancies_manager_directory__delete_sl_delete_sl($props,&$parentDesc,$aspect)
	{
