...
class recruitment_vacancies_manager_directory__pdf_interview_synthesis_pdf_interview_synthesis extends NxPage
{
	function recruitment_vacancies_manager_directory__pdf_interview_synthesis_pdf_interview_synthesis($props,&$parentDesc,$aspect)
	{
	...
	function run()
	{
					...
					$this->getRecord('rct_interview_synthesis.pdf@recruitment','page.record','db',false,null,null);
					$this->runView('/recruitment/vacancies/manager/directory__interview_synthesis_pdf',array(
						'fmethod' => 'toHTML',
