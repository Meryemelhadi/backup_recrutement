...
class recruitment_vacancies_manager_directory__warning_warning extends NxPage
{
	function recruitment_vacancies_manager_directory__warning_warning($props,&$parentDesc,$aspect)
	{
	...
	function run()
	{
					$this->setProperty("current_operation",'warning');
					...
					$this->setProperty("vacancy_oid",(isset($_REQUEST["oid"])?$_REQUEST["oid"]:""));
					$this->setProperty('schedule.url',$_SERVER["PHP_SELF"].'?nxo=schedule_warning&amp;nxs=&amp;vacancy_oid='.$this->getProperty("vacancy_oid",""));
					$this->setProperty('edit.url',$_SERVER["PHP_SELF"].'?nxo=edit_warning&amp;nxs=&amp;vacancy_oid='.$this->getProperty("vacancy_oid",""));
					$this->setProperty('delete.url',$_SERVER["PHP_SELF"].'?nxo=delete_warning&amp;nxs=&amp;vacancy_oid='.$this->getProperty("vacancy_oid",""));
					$this->getRecords('rct_warning.list@recruitment','page.records','db',false,null,null);
					$this->runView('/recruitment/vacancies/manager/directory__warning',array(
						'fmethod' => 'toHTML',
