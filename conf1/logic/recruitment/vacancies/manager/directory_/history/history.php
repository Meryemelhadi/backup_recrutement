...
class recruitment_vacancies_manager_directory__history_history extends NxPage
{
	function recruitment_vacancies_manager_directory__history_history($props,&$parentDesc,$aspect)
	{
	...
	function run()
	{
					...
					$this->getRecords('rct_vacancy_history.by_vacancy','vacancy_history.records','db',false,null,null);
					$this->setProperty("current_operation",'history');
					...
					$this->runView('/recruitment/vacancies/manager/directory__history',array(
						'fmethod' => 'toHTML',
