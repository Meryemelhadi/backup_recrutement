...
class recruitment_vacancies_manager_directory__delete_interview_delete_interview extends NxPage
{
	function recruitment_vacancies_manager_directory__delete_interview_delete_interview($props,&$parentDesc,$aspect)
	{
