...
class recruitment_vacancies_manager_directory__feedback_feedback extends NxPage
{
	function recruitment_vacancies_manager_directory__feedback_feedback($props,&$parentDesc,$aspect)
	{
	...
	function run()
	{
					...
					$this->getRecords('rct_instant_feedback.admin_list@recruitment','instant_feedback.records','db',false,null,null);
					$this->getRecords('rct_delayed_feedback.admin_list@recruitment','delayed_feedback.records','db',false,null,null);
					$this->runView('/recruitment/vacancies/manager/directory__feedback',array(
						'fmethod' => 'toHTML',
