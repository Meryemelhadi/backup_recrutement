...
class recruitment_vacancies_manager_directory__send_to_ic_process_send_to_ic_process extends NxPage
{
	function recruitment_vacancies_manager_directory__send_to_ic_process_send_to_ic_process($props,&$parentDesc,$aspect)
	{
