...
class recruitment_vacancies_manager_directory__handle_proposal_from_candidate_handle_proposal extends NxPage
{
	function recruitment_vacancies_manager_directory__handle_proposal_from_candidate_handle_proposal($props,&$parentDesc,$aspect)
	{
	...
	function run()
	{
					...
					$this->runView('/recruitment/vacancies/manager/directory__handle_proposal',array(
						'fmethod' => 'toHTML',
