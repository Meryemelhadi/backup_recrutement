...
class recruitment_vacancies_manager_directory__complete_instant_feedback_complete_instant_feedback extends NxPage
{
	function recruitment_vacancies_manager_directory__complete_instant_feedback_complete_instant_feedback($props,&$parentDesc,$aspect)
	{
	...
	function run()
	{
					...
					$this->getRecord('rct_instant_feedback.complete@recruitment','page.record','db',false,null,null);
					$this->runView('/recruitment/vacancies/manager/directory__feedback_write',array(
						'fmethod' => 'toHTML',
