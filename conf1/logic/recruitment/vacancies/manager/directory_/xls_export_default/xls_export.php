...
class recruitment_vacancies_manager_directory__xls_export_default_xls_export extends NxPage
{
	function recruitment_vacancies_manager_directory__xls_export_default_xls_export($props,&$parentDesc,$aspect)
	{
