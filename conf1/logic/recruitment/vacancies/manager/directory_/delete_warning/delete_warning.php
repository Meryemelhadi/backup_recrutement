...
class recruitment_vacancies_manager_directory__delete_warning_delete_warning extends NxPage
{
	function recruitment_vacancies_manager_directory__delete_warning_delete_warning($props,&$parentDesc,$aspect)
	{
