...
class recruitment_vacancies_client_directory__view_mail_view_mail extends NxPage
{
	function recruitment_vacancies_client_directory__view_mail_view_mail($props,&$parentDesc,$aspect)
	{
	...
	function run()
	{
					...
					$this->runView('/recruitment/vacancies/client/directory__email_view',array(
						'fmethod' => 'toHTML',
