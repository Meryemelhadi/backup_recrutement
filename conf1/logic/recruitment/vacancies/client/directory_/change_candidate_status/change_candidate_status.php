...
class recruitment_vacancies_client_directory__change_candidate_status_change_candidate_status extends NxPage
{
	function recruitment_vacancies_client_directory__change_candidate_status_change_candidate_status($props,&$parentDesc,$aspect)
	{
