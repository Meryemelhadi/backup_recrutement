...
class recruitment_vacancies_client_directory__validate_interview_validate_interview extends NxPage
{
	function recruitment_vacancies_client_directory__validate_interview_validate_interview($props,&$parentDesc,$aspect)
	{
	...
	function run()
	{
					...
					$this->runView('/recruitment/vacancies/client/directory__interview_validate',array(
						'fmethod' => 'toHTML',
