...
class recruitment_vacancies_client_directory__unlink_candidate_sl_unlink_candidate_sl extends NxPage
{
	function recruitment_vacancies_client_directory__unlink_candidate_sl_unlink_candidate_sl($props,&$parentDesc,$aspect)
	{
