...
class recruitment_vacancies_client_directory__add_short_list_add_short_list_process extends NxPage
{
	function recruitment_vacancies_client_directory__add_short_list_add_short_list_process($props,&$parentDesc,$aspect)
	{
	...
	function run()
	{
					...
					$this->putRecord(
						$this->getRecord('rct_short_list.add@recruitment','page.records','post',false,null,null),'rct_short_list.add@recruitment','insert','db','Object',null);
					$this->setProperty("short_list_oid",
						$this->getLastInsertID('db'));
					$this->putRecord(
						$_nx_record_data17=array(
