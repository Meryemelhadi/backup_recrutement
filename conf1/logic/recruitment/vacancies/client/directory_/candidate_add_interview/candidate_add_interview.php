...
class recruitment_vacancies_client_directory__candidate_add_interview_candidate_add_interview extends NxPage
{
	function recruitment_vacancies_client_directory__candidate_add_interview_candidate_add_interview($props,&$parentDesc,$aspect)
	{
	...
	function run()
	{
					...
					$this->setProperty("vacancy_oid",(isset($_REQUEST["vacancy_oid"])?$_REQUEST["vacancy_oid"]:""));
					$this->getRecord('rct_interview.candidate_add_client@recruitment','page.record','empty',false,null,null);
