...
class recruitment_vacancies_client_directory__view_provider_view_provider extends NxPage
{
	function recruitment_vacancies_client_directory__view_provider_view_provider($props,&$parentDesc,$aspect)
	{
	...
	function run()
	{
					...
					$this->runView('/recruitment/vacancies/client/directory__provider_view',array(
						'fmethod' => 'toHTML',
