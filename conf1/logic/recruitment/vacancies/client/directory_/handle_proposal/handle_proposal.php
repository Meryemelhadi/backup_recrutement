...
class recruitment_vacancies_client_directory__handle_proposal_handle_proposal extends NxPage
{
	function recruitment_vacancies_client_directory__handle_proposal_handle_proposal($props,&$parentDesc,$aspect)
	{
	...
	function run()
	{
					...
					$this->runView('/recruitment/vacancies/client/directory__handle_proposal',array(
						'fmethod' => 'toHTML',
