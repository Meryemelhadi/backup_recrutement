...
class recruitment_vacancies_client_directory__recruitment_providers_recruitment_providers extends NxPage
{
	function recruitment_vacancies_client_directory__recruitment_providers_recruitment_providers($props,&$parentDesc,$aspect)
	{
	...
	function run()
	{
					...
					$this->runView('/recruitment/vacancies/client/directory__recruitment_providers',array(
						'fmethod' => 'toHTML',
