...
class recruitment_vacancies_client_directory__rate_candidate_rate_candidate extends NxPage
{
	function recruitment_vacancies_client_directory__rate_candidate_rate_candidate($props,&$parentDesc,$aspect)
	{
