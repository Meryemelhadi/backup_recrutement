...
class recruitment_vacancies_client_directory__schedule_delayed_feedback_schedule_delayed_feedback extends NxPage
{
	function recruitment_vacancies_client_directory__schedule_delayed_feedback_schedule_delayed_feedback($props,&$parentDesc,$aspect)
	{
	...
	function run()
	{
					...
					$this->runView('/recruitment/vacancies/client/directory__feedback_schedule',array(
						'fmethod' => 'toHTML',
