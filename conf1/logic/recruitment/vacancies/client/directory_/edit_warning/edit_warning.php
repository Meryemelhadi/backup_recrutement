...
class recruitment_vacancies_client_directory__edit_warning_edit_warning extends NxPage
{
	function recruitment_vacancies_client_directory__edit_warning_edit_warning($props,&$parentDesc,$aspect)
	{
	...
	function run()
	{
					...
					$this->runView('/recruitment/vacancies/client/directory__warning_edit',array(
						'fmethod' => 'toHTML',
