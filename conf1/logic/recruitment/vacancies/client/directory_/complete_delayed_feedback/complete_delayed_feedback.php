...
class recruitment_vacancies_client_directory__complete_delayed_feedback_complete_delayed_feedback extends NxPage
{
	function recruitment_vacancies_client_directory__complete_delayed_feedback_complete_delayed_feedback($props,&$parentDesc,$aspect)
	{
	...
	function run()
	{
					...
					$this->setProperty('submit.url',$_SERVER["PHP_SELF"].'?nxo=complete_delayed_feedback_process&amp;nxs=');
					$this->getRecord('rct_delayed_feedback.complete_client@recruitment','page.record','db',false,null,null);
					$this->runView('/recruitment/vacancies/client/directory__feedback_delayed_write',array(
						'fmethod' => 'toHTML',
