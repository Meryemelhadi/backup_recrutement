...
class recruitment_candidates_directory__send_to_client_display extends NxPage
{
	function recruitment_candidates_directory__send_to_client_display($props,&$parentDesc,$aspect)
	{
