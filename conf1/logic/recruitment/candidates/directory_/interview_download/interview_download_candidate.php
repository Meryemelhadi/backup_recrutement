...
class recruitment_candidates_directory__interview_download_interview_download_candidate extends NxPage
{
	function recruitment_candidates_directory__interview_download_interview_download_candidate($props,&$parentDesc,$aspect)
	{
