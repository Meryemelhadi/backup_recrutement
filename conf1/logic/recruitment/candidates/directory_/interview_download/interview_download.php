...
class recruitment_candidates_directory__interview_download_interview_download extends NxPage
{
	function recruitment_candidates_directory__interview_download_interview_download($props,&$parentDesc,$aspect)
	{
