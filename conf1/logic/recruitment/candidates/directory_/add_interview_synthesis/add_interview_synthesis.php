...
class recruitment_candidates_directory__add_interview_synthesis_add_interview_synthesis extends NxPage
{
	function recruitment_candidates_directory__add_interview_synthesis_add_interview_synthesis($props,&$parentDesc,$aspect)
	{
	...
	function run()
	{
					...
					$this->runView('/recruitment/candidates/directory__interview_synthesis_add',array(
						'fmethod' => 'toHTML',
