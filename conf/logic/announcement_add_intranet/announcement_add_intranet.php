...
class announcement_add_intranet_announcement_add_intranet extends NxPage
{
	function announcement_add_intranet_announcement_add_intranet($props,&$parentDesc,$aspect)
	{
	...
	function run()
	{
							...
							$this->runView('_announcement_add',array(
								'fmethod' => 'toHTML',
