...
class view_interview_synthesis_view_interview_synthesis extends NxPage
{
	function view_interview_synthesis_view_interview_synthesis($props,&$parentDesc,$aspect)
	{
	...
	function run()
	{
							...
							$this->runView('_interview_synthesis_view',array(
								'fmethod' => 'toHTML',
