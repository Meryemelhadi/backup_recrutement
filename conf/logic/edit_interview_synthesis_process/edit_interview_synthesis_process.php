...
class edit_interview_synthesis_process_edit_interview_synthesis_process extends NxPage
{
	function edit_interview_synthesis_process_edit_interview_synthesis_process($props,&$parentDesc,$aspect)
	{
