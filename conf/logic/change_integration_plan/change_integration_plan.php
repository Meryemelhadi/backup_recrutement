...
class change_integration_plan_change_integration_plan extends NxPage
{
	function change_integration_plan_change_integration_plan($props,&$parentDesc,$aspect)
	{
	...
	function run()
	{
							...
							$this->runView('_modalbox_form',array(
								'fmethod' => 'toHTML',
