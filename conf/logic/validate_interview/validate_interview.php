...
class validate_interview_validate_interview extends NxPage
{
	function validate_interview_validate_interview($props,&$parentDesc,$aspect)
	{
	...
	function run()
	{
							...
							$this->runView('_interview_validate',array(
								'fmethod' => 'toHTML',
