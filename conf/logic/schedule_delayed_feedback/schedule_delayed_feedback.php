...
class schedule_delayed_feedback_schedule_delayed_feedback extends NxPage
{
	function schedule_delayed_feedback_schedule_delayed_feedback($props,&$parentDesc,$aspect)
	{
