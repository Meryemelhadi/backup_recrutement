...
class recruitment_vacancies_admin_directory__delete_prest_process extends NxPage
{
	function recruitment_vacancies_admin_directory__delete_prest_process($props,&$parentDesc,$aspect)
	{
