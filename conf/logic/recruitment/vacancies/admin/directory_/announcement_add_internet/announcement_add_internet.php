...
class recruitment_vacancies_admin_directory__announcement_add_internet_announcement_add_internet extends NxPage
{
	function recruitment_vacancies_admin_directory__announcement_add_internet_announcement_add_internet($props,&$parentDesc,$aspect)
	{
	...
	function run()
	{
					...
					$this->runView('/recruitment/vacancies/admin/directory__announcement_add_internet',array(
						'fmethod' => 'toHTML',
