...
class recruitment_vacancies_admin_directory__edit_warning_edit_warning extends NxPage
{
	function recruitment_vacancies_admin_directory__edit_warning_edit_warning($props,&$parentDesc,$aspect)
	{
	...
	function run()
	{
					...
					$this->runView('/recruitment/vacancies/admin/directory__warning_edit',array(
						'fmethod' => 'toHTML',
