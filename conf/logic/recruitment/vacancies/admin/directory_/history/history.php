...
class recruitment_vacancies_admin_directory__history_history extends NxPage
{
	function recruitment_vacancies_admin_directory__history_history($props,&$parentDesc,$aspect)
	{
	...
	function run()
	{
					...
					$this->runView('/recruitment/vacancies/admin/directory__history',array(
						'fmethod' => 'toHTML',
