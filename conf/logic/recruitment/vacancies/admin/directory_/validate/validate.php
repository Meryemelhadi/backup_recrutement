...
class recruitment_vacancies_admin_directory__validate_validate extends NxPage
{
	function recruitment_vacancies_admin_directory__validate_validate($props,&$parentDesc,$aspect)
	{
	...
	function run()
	{
					...
					$this->setProperty('list.url',$_SERVER["PHP_SELF"].'?nxo=list&amp;nxs='.(isset($_REQUEST["filterKey"])?$_REQUEST["filterKey"]:""));
					...
					$this->runView('/recruitment/vacancies/admin/directory__view',array(
						'fmethod' => 'toForm',
