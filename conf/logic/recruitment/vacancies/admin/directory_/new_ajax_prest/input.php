...
class recruitment_vacancies_admin_directory__new_ajax_prest_input extends NxPage
{
	function recruitment_vacancies_admin_directory__new_ajax_prest_input($props,&$parentDesc,$aspect)
	{
	...
	function run()
	{
					...
					$this->runView('/recruitment/vacancies/admin/directory__add_prest',array(
						'fmethod' => 'toForm',
