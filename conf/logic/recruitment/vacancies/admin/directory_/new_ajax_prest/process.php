...
class recruitment_vacancies_admin_directory__new_ajax_prest_process extends NxPage
{
	function recruitment_vacancies_admin_directory__new_ajax_prest_process($props,&$parentDesc,$aspect)
	{
