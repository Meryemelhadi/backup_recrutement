...
class recruitment_vacancies_admin_directory__validate_interview_validate_interview extends NxPage
{
	function recruitment_vacancies_admin_directory__validate_interview_validate_interview($props,&$parentDesc,$aspect)
	{
	...
	function run()
	{
					...
					$this->runView('/recruitment/vacancies/admin/directory__interview_validate',array(
						'fmethod' => 'toHTML',
