...
class recruitment_vacancies_admin_directory__validate_interview_validate_interview_process extends NxPage
{
	function recruitment_vacancies_admin_directory__validate_interview_validate_interview_process($props,&$parentDesc,$aspect)
	{
