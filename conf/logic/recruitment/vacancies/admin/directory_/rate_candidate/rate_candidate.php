...
class recruitment_vacancies_admin_directory__rate_candidate_rate_candidate extends NxPage
{
	function recruitment_vacancies_admin_directory__rate_candidate_rate_candidate($props,&$parentDesc,$aspect)
	{
