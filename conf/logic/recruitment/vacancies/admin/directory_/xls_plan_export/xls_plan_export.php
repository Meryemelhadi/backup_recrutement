...
class recruitment_vacancies_admin_directory__xls_plan_export_xls_plan_export extends NxPage
{
	function recruitment_vacancies_admin_directory__xls_plan_export_xls_plan_export($props,&$parentDesc,$aspect)
	{
