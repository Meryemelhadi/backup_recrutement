...
class recruitment_vacancies_admin_directory__feedback_feedback extends NxPage
{
	function recruitment_vacancies_admin_directory__feedback_feedback($props,&$parentDesc,$aspect)
	{
	...
	function run()
	{
					...
					$this->runView('/recruitment/vacancies/admin/directory__feedback',array(
						'fmethod' => 'toHTML',
