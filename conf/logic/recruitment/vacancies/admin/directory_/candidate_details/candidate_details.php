...
class recruitment_vacancies_admin_directory__candidate_details_candidate_details extends NxPage
{
	function recruitment_vacancies_admin_directory__candidate_details_candidate_details($props,&$parentDesc,$aspect)
	{
	...
	function run()
	{
					...
					$this->runView('/recruitment/vacancies/admin/directory__candidate_details',array(
						'fmethod' => 'toHTML',
