...
class recruitment_vacancies_admin_directory__delete_instant_feedback_delete_instant_feedback extends NxPage
{
	function recruitment_vacancies_admin_directory__delete_instant_feedback_delete_instant_feedback($props,&$parentDesc,$aspect)
	{
