...
class recruitment_vacancies_admin_directory__unlink_candidate_unlink_candidat extends NxPage
{
	function recruitment_vacancies_admin_directory__unlink_candidate_unlink_candidat($props,&$parentDesc,$aspect)
	{
