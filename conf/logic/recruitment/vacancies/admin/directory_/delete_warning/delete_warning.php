...
class recruitment_vacancies_admin_directory__delete_warning_delete_warning extends NxPage
{
	function recruitment_vacancies_admin_directory__delete_warning_delete_warning($props,&$parentDesc,$aspect)
	{
