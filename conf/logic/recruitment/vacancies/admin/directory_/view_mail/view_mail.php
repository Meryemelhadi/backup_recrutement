...
class recruitment_vacancies_admin_directory__view_mail_view_mail extends NxPage
{
	function recruitment_vacancies_admin_directory__view_mail_view_mail($props,&$parentDesc,$aspect)
	{
	...
	function run()
	{
					...
					$this->runView('/recruitment/vacancies/admin/directory__email_view',array(
						'fmethod' => 'toHTML',
