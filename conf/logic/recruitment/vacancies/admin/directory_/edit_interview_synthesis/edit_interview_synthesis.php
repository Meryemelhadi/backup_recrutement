...
class recruitment_vacancies_admin_directory__edit_interview_synthesis_edit_interview_synthesis extends NxPage
{
	function recruitment_vacancies_admin_directory__edit_interview_synthesis_edit_interview_synthesis($props,&$parentDesc,$aspect)
	{
	...
	function run()
	{
					...
					$this->runView('/recruitment/vacancies/admin/directory__interview_synthesis_edit',array(
						'fmethod' => 'toHTML',
