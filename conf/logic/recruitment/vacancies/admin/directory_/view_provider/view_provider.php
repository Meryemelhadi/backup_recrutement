...
class recruitment_vacancies_admin_directory__view_provider_view_provider extends NxPage
{
	function recruitment_vacancies_admin_directory__view_provider_view_provider($props,&$parentDesc,$aspect)
	{
	...
	function run()
	{
					...
					$this->runView('/recruitment/vacancies/admin/directory__provider_view',array(
						'fmethod' => 'toHTML',
