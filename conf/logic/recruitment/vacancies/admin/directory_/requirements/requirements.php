...
class recruitment_vacancies_admin_directory__requirements_requirements extends NxPage
{
	function recruitment_vacancies_admin_directory__requirements_requirements($props,&$parentDesc,$aspect)
	{
	...
	function run()
	{
					...
					$this->runView('/recruitment/vacancies/admin/directory__requirements',array(
						'fmethod' => 'toHTML',
