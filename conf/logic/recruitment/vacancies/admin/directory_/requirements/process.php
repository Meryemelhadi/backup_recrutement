...
class recruitment_vacancies_admin_directory__requirements_process extends NxPage
{
	function recruitment_vacancies_admin_directory__requirements_process($props,&$parentDesc,$aspect)
	{
