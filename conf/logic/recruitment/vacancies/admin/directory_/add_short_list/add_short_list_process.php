...
class recruitment_vacancies_admin_directory__add_short_list_add_short_list_process extends NxPage
{
	function recruitment_vacancies_admin_directory__add_short_list_add_short_list_process($props,&$parentDesc,$aspect)
	{
