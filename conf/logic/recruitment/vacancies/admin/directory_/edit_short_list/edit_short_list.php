...
class recruitment_vacancies_admin_directory__edit_short_list_edit_short_list extends NxPage
{
	function recruitment_vacancies_admin_directory__edit_short_list_edit_short_list($props,&$parentDesc,$aspect)
	{
	...
	function run()
	{
					...
					$this->runView('/recruitment/vacancies/admin/directory__short_list_edit',array(
						'fmethod' => 'toHTML',
