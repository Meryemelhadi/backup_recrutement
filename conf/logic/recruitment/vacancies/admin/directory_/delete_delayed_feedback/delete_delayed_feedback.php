...
class recruitment_vacancies_admin_directory__delete_delayed_feedback_delete_delayed_feedback extends NxPage
{
	function recruitment_vacancies_admin_directory__delete_delayed_feedback_delete_delayed_feedback($props,&$parentDesc,$aspect)
	{
