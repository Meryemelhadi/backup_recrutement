...
class recruitment_vacancies_admin_directory__change_integration_note_change_contrat_signing extends NxPage
{
	function recruitment_vacancies_admin_directory__change_integration_note_change_contrat_signing($props,&$parentDesc,$aspect)
	{
