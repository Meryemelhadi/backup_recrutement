...
class recruitment_vacancies_admin_directory__edit_process extends NxPage
{
	function recruitment_vacancies_admin_directory__edit_process($props,&$parentDesc,$aspect)
	{
