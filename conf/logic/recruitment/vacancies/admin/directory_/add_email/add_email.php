...
class recruitment_vacancies_admin_directory__add_email_add_email extends NxPage
{
	function recruitment_vacancies_admin_directory__add_email_add_email($props,&$parentDesc,$aspect)
	{
	...
	function run()
	{
					...
					$this->runView('/recruitment/vacancies/admin/directory__email_add',array(
						'fmethod' => 'toHTML',
