...
class recruitment_vacancies_admin_directory__new_ajax_input extends NxPage
{
	function recruitment_vacancies_admin_directory__new_ajax_input($props,&$parentDesc,$aspect)
	{
	...
	function run()
	{
					...
					$this->runView('/recruitment/vacancies/admin/directory__add_description',array(
						'fmethod' => 'toForm',
