...
class recruitment_vacancies_admin_directory__warning_warning extends NxPage
{
	function recruitment_vacancies_admin_directory__warning_warning($props,&$parentDesc,$aspect)
	{
	...
	function run()
	{
					...
					$this->runView('/recruitment/vacancies/admin/directory__warning',array(
						'fmethod' => 'toHTML',
