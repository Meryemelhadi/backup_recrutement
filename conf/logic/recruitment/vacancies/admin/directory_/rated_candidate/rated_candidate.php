...
class recruitment_vacancies_admin_directory__rated_candidate_rated_candidate extends NxPage
{
	function recruitment_vacancies_admin_directory__rated_candidate_rated_candidate($props,&$parentDesc,$aspect)
	{
	...
	function run()
	{
					...
					$this->runView('/recruitment/vacancies/admin/directory__rated_candidate',array(
						'fmethod' => 'toHTML',
