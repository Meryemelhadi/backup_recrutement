...
class recruitment_vacancies_admin_directory__xls_export_xls_export extends NxPage
{
	function recruitment_vacancies_admin_directory__xls_export_xls_export($props,&$parentDesc,$aspect)
	{
