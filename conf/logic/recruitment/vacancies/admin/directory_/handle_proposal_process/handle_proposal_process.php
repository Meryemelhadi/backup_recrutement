...
class recruitment_vacancies_admin_directory__handle_proposal_process_handle_proposal_process extends NxPage
{
	function recruitment_vacancies_admin_directory__handle_proposal_process_handle_proposal_process($props,&$parentDesc,$aspect)
	{
