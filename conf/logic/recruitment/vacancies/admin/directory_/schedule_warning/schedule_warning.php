...
class recruitment_vacancies_admin_directory__schedule_warning_schedule_warning extends NxPage
{
	function recruitment_vacancies_admin_directory__schedule_warning_schedule_warning($props,&$parentDesc,$aspect)
	{
	...
	function run()
	{
					...
					$this->runView('/recruitment/vacancies/admin/directory__warning_schedule',array(
						'fmethod' => 'toHTML',
