...
class recruitment_vacancies_client_directory__interview_download_interview_download_candidate extends NxPage
{
	function recruitment_vacancies_client_directory__interview_download_interview_download_candidate($props,&$parentDesc,$aspect)
	{
