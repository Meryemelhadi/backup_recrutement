...
class recruitment_vacancies_client_directory__schedule_warning_schedule_warning extends NxPage
{
	function recruitment_vacancies_client_directory__schedule_warning_schedule_warning($props,&$parentDesc,$aspect)
	{
	...
	function run()
	{
					...
					$this->runView('/recruitment/vacancies/client/directory__warning_schedule',array(
						'fmethod' => 'toHTML',
