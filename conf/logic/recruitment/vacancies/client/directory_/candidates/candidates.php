...
class recruitment_vacancies_client_directory__candidates_candidates extends NxPage
{
	function recruitment_vacancies_client_directory__candidates_candidates($props,&$parentDesc,$aspect)
	{
	...
	function run()
	{
					...
					$this->setProperty('search.url',$_SERVER["PHP_SELF"].'?nxo=candidates_search_results&amp;nxs=&amp;vacancy_oid='.$this->getProperty("vacancy_oid",""));
					...
					$this->getRecords('handler:recruitment.candidates_client.selected@recruitment','candidates_selected.records','db',false,null,null);
					$this->getRecords('rct_short_list.by_vacancy_with_candidates_client@recruitment','short_lists.records','db',false,null,null);
					$this->getRecords('rct_candidate_vacancy_client.by_vacancy@recruitment','candidates_proposed.records','db',false,null,null);
					$this->runView('/recruitment/vacancies/client/directory__candidates',array(
						'fmethod' => 'toHTML',
