...
class recruitment_vacancies_client_directory__warning_warning extends NxPage
{
	function recruitment_vacancies_client_directory__warning_warning($props,&$parentDesc,$aspect)
	{
	...
	function run()
	{
					...
					$this->runView('/recruitment/vacancies/client/directory__warning',array(
						'fmethod' => 'toHTML',
