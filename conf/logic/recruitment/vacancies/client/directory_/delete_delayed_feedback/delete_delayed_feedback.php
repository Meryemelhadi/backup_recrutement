...
class recruitment_vacancies_client_directory__delete_delayed_feedback_delete_delayed_feedback extends NxPage
{
	function recruitment_vacancies_client_directory__delete_delayed_feedback_delete_delayed_feedback($props,&$parentDesc,$aspect)
	{
