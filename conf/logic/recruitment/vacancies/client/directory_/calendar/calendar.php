...
class recruitment_vacancies_client_directory__calendar_calendar extends NxPage
{
	function recruitment_vacancies_client_directory__calendar_calendar($props,&$parentDesc,$aspect)
	{
	...
	function run()
	{
					...
					$this->runView('/recruitment/vacancies/client/directory__calendar',array(
						'fmethod' => 'toHTML',
