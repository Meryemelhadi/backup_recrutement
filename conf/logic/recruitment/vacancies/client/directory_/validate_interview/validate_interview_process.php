...
class recruitment_vacancies_client_directory__validate_interview_validate_interview_process extends NxPage
{
	function recruitment_vacancies_client_directory__validate_interview_validate_interview_process($props,&$parentDesc,$aspect)
	{
