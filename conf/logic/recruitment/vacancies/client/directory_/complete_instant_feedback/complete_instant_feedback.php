...
class recruitment_vacancies_client_directory__complete_instant_feedback_complete_instant_feedback extends NxPage
{
	function recruitment_vacancies_client_directory__complete_instant_feedback_complete_instant_feedback($props,&$parentDesc,$aspect)
	{
	...
	function run()
	{
					...
					$this->setProperty('submit.url',$_SERVER["PHP_SELF"].'?nxo=complete_instant_feedback_process&amp;nxs=');
					$this->getRecord('rct_instant_feedback.complete_client@recruitment','page.record','db',false,null,null);
					$this->runView('/recruitment/vacancies/client/directory__feedback_write',array(
						'fmethod' => 'toHTML',
