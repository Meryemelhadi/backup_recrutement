...
class recruitment_vacancies_client_directory__view_instant_feedback_view_instant_feedback extends NxPage
{
	function recruitment_vacancies_client_directory__view_instant_feedback_view_instant_feedback($props,&$parentDesc,$aspect)
	{
	...
	function run()
	{
					...
					$this->getRecord('rct_instant_feedback.view_client@recruitment','page.record','db',false,null,null);
					$this->runView('/recruitment/vacancies/client/directory__feedback_instant_view',array(
						'fmethod' => 'toHTML',
