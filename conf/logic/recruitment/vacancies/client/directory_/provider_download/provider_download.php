...
class recruitment_vacancies_client_directory__provider_download_provider_download extends NxPage
{
	function recruitment_vacancies_client_directory__provider_download_provider_download($props,&$parentDesc,$aspect)
	{
