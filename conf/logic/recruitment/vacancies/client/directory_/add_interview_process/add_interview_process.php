...
class recruitment_vacancies_client_directory__add_interview_process_add_interview_process extends NxPage
{
	function recruitment_vacancies_client_directory__add_interview_process_add_interview_process($props,&$parentDesc,$aspect)
	{
	...
	function run()
	{
				...
				$lastOids = array();
					...
					foreach($candidates_oids as $i=>$value)
					{
						...
						$this->putRecord(
							$this->getRecord('rct_interview.add_to_candidate@recruitment','page.record','post',false,null,null),'rct_interview.add_to_candidate@recruitment','insert','db','Object',null);
						$lastOid=
