...
class recruitment_vacancies_client_directory__edit_interview_edit_interview extends NxPage
{
	function recruitment_vacancies_client_directory__edit_interview_edit_interview($props,&$parentDesc,$aspect)
	{
	...
	function run()
	{
					...
					$this->runView('/recruitment/vacancies/client/directory__interview_edit',array(
						'fmethod' => 'toHTML',
