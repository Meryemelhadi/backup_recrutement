...
class recruitment_vacancies_client_directory__email_download_email_download extends NxPage
{
	function recruitment_vacancies_client_directory__email_download_email_download($props,&$parentDesc,$aspect)
	{
