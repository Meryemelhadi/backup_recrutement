...
class recruitment_vacancies_client_directory__candidate_details_candidate_details extends NxPage
{
	function recruitment_vacancies_client_directory__candidate_details_candidate_details($props,&$parentDesc,$aspect)
	{
	...
	function run()
	{
					...
					$this->runView('/recruitment/vacancies/client/directory__candidate_details',array(
						'fmethod' => 'toHTML',
