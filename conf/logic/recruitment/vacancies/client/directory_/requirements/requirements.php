...
class recruitment_vacancies_client_directory__requirements_requirements extends NxPage
{
	function recruitment_vacancies_client_directory__requirements_requirements($props,&$parentDesc,$aspect)
	{
	...
	function run()
	{
					...
					$this->runView('/recruitment/vacancies/client/directory__requirements',array(
						'fmethod' => 'toHTML',
