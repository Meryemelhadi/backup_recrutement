...
class recruitment_vacancies_client_directory__request_provider_process_request_provider_process extends NxPage
{
	function recruitment_vacancies_client_directory__request_provider_process_request_provider_process($props,&$parentDesc,$aspect)
	{
	...
	function run()
	{
					...
					$this->putRecord(
						$this->getRecord('rct_vacancy_provider.add@recruitment','page.records','post',false,null,null),'rct_vacancy_provider.add@recruitment','insert','db','Object',null);
					$oid=
