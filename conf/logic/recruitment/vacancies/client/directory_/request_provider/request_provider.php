...
class recruitment_vacancies_client_directory__request_provider_request_provider extends NxPage
{
	function recruitment_vacancies_client_directory__request_provider_request_provider($props,&$parentDesc,$aspect)
	{
	...
	function run()
	{
					...
					$this->runView('/recruitment/vacancies/client/directory__provider_add',array(
						'fmethod' => 'toHTML',
