...
class recruitment_vacancies_manager_directory__interview_download_interview_download extends NxPage
{
	function recruitment_vacancies_manager_directory__interview_download_interview_download($props,&$parentDesc,$aspect)
	{
