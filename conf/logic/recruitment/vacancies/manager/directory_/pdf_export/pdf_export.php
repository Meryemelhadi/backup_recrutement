...
class recruitment_vacancies_manager_directory__pdf_export_pdf_export extends NxPage
{
	function recruitment_vacancies_manager_directory__pdf_export_pdf_export($props,&$parentDesc,$aspect)
	{
