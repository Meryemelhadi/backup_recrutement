...
class recruitment_vacancies_manager_directory__add_to_short_list_add_to_short_list_process extends NxPage
{
	function recruitment_vacancies_manager_directory__add_to_short_list_add_to_short_list_process($props,&$parentDesc,$aspect)
	{
