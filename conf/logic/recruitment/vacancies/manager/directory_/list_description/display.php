...
class recruitment_vacancies_manager_directory__list_description_display extends NxPage
{
	function recruitment_vacancies_manager_directory__list_description_display($props,&$parentDesc,$aspect)
	{
	...
	function run()
	{
					$this->getRecords('rct_entreprise_description_rekrute.ds_list','page.records','db',false,null,null);
					...
					$this->runView('/recruitment/vacancies/manager/directory__list_description_ajax',array(
						'fmethod' => 'toHTML',
