...
class recruitment_vacancies_manager_directory__view_delayed_feedback_view_delayed_feedback extends NxPage
{
	function recruitment_vacancies_manager_directory__view_delayed_feedback_view_delayed_feedback($props,&$parentDesc,$aspect)
	{
	...
	function run()
	{
					...
					$this->runView('/recruitment/vacancies/manager/directory__feedback_view',array(
						'fmethod' => 'toHTML',
