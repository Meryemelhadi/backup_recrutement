...
class recruitment_vacancies_manager_directory__new_ajax_process extends NxPage
{
	function recruitment_vacancies_manager_directory__new_ajax_process($props,&$parentDesc,$aspect)
	{
