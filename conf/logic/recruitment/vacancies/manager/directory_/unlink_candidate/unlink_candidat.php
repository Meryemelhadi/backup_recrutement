...
class recruitment_vacancies_manager_directory__unlink_candidate_unlink_candidat extends NxPage
{
	function recruitment_vacancies_manager_directory__unlink_candidate_unlink_candidat($props,&$parentDesc,$aspect)
	{
