...
class recruitment_vacancies_manager_directory__edit_edit extends NxPage
{
	function recruitment_vacancies_manager_directory__edit_edit($props,&$parentDesc,$aspect)
	{
	...
	function run()
	{
					...
					$creator=
						...
						{
							$this->runView('/recruitment/vacancies/manager/directory__edit',array(
								'fmethod' => 'toHTML',

								),null);
						}
						else {
							$this->runView('/recruitment/vacancies/manager/directory__readonly',array(
								'fmethod' => 'toHTML',
