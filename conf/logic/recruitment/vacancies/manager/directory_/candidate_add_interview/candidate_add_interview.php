...
class recruitment_vacancies_manager_directory__candidate_add_interview_candidate_add_interview extends NxPage
{
	function recruitment_vacancies_manager_directory__candidate_add_interview_candidate_add_interview($props,&$parentDesc,$aspect)
	{
	...
	function run()
	{
					...
					$this->runView('/recruitment/vacancies/manager/directory__interview_add',array(
						'fmethod' => 'toHTML',
