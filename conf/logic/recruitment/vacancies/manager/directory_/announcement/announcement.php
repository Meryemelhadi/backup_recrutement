...
class recruitment_vacancies_manager_directory__announcement_announcement extends NxPage
{
	function recruitment_vacancies_manager_directory__announcement_announcement($props,&$parentDesc,$aspect)
	{
	...
	function run()
	{
					$this->setProperty("current_operation",'announcement');
					...
					$this->setProperty("vacancy_oid",(isset($_REQUEST["oid"])?$_REQUEST["oid"]:""));
					$this->getRecords('rct_announcement.list_intranet_by_vacancy','announcements_intranet.records','db',false,null,null);
					$this->getRecords('rct_announcement_rekrute.list_internet_by_vacancy','announcements_internet.records','db',false,null,null);
					$this->setProperty('announcement_add_intranet.url',$_SERVER["PHP_SELF"].'?nxo=announcement_add_intranet&amp;nxs=&amp;oid='.(isset($_REQUEST["oid"])?$_REQUEST["oid"]:""));
					$this->setProperty('announcement_add_internet.url',$_SERVER["PHP_SELF"].'?nxo=announcement_add_internet&amp;nxs=&amp;oid='.(isset($_REQUEST["oid"])?$_REQUEST["oid"]:""));
					$this->runView('/recruitment/vacancies/manager/directory__announcement',array(
						'fmethod' => 'toHTML',
