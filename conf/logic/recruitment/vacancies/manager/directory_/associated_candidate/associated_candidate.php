...
class recruitment_vacancies_manager_directory__associated_candidate_associated_candidate extends NxPage
{
	function recruitment_vacancies_manager_directory__associated_candidate_associated_candidate($props,&$parentDesc,$aspect)
	{
	...
	function run()
	{
					...
					$this->setProperty('candidate_record.url',$_SERVER["PHP_SELF"].'?nxo=associated_candidate&amp;nxs=associated_candidate_record&amp;vacancy_oid='.$this->getProperty("vacancy_oid",""));
					...
					$this->setProperty('search.url',$_SERVER["PHP_SELF"].'?nxo=associated_candidate&amp;nxs=&amp;vacancy_oid='.$this->getProperty("vacancy_oid","").'&amp;oid='.$this->getProperty("vacancy_oid",""));
					...
					$this->runView('/recruitment/vacancies/manager/directory__associated_candidate',array(
						'fmethod' => 'toHTML',
