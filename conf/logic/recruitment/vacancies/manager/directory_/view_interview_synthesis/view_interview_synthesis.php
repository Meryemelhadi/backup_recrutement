...
class recruitment_vacancies_manager_directory__view_interview_synthesis_view_interview_synthesis extends NxPage
{
	function recruitment_vacancies_manager_directory__view_interview_synthesis_view_interview_synthesis($props,&$parentDesc,$aspect)
	{
	...
	function run()
	{
					...
					$this->runView('/recruitment/vacancies/manager/directory__interview_synthesis_view',array(
						'fmethod' => 'toHTML',
