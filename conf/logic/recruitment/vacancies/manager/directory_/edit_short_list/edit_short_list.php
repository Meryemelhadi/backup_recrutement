...
class recruitment_vacancies_manager_directory__edit_short_list_edit_short_list extends NxPage
{
	function recruitment_vacancies_manager_directory__edit_short_list_edit_short_list($props,&$parentDesc,$aspect)
	{
	...
	function run()
	{
					...
					$this->runView('/recruitment/vacancies/manager/directory__short_list_edit',array(
						'fmethod' => 'toHTML',
