...
class recruitment_vacancies_manager_directory__shorts_list_shorts_list extends NxPage
{
	function recruitment_vacancies_manager_directory__shorts_list_shorts_list($props,&$parentDesc,$aspect)
	{
	...
	function run()
	{
					...
					$this->setProperty('search.url',$_SERVER["PHP_SELF"].'?nxo=shorts_list&amp;nxs=&amp;vacancy_oid='.$this->getProperty("vacancy_oid","").'&amp;oid='.$this->getProperty("vacancy_oid",""));
					...
					$this->runView('/recruitment/vacancies/manager/directory__shorts_list',array(
						'fmethod' => 'toHTML',
