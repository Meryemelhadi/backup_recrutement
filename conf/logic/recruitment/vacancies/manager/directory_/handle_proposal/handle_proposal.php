...
class recruitment_vacancies_manager_directory__handle_proposal_handle_proposal extends NxPage
{
	function recruitment_vacancies_manager_directory__handle_proposal_handle_proposal($props,&$parentDesc,$aspect)
	{
