...
class recruitment_vacancies_manager_directory__delete_description_process extends NxPage
{
	function recruitment_vacancies_manager_directory__delete_description_process($props,&$parentDesc,$aspect)
	{
