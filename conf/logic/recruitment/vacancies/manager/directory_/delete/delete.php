...
class recruitment_vacancies_manager_directory__delete_delete extends NxPage
{
	function recruitment_vacancies_manager_directory__delete_delete($props,&$parentDesc,$aspect)
	{
