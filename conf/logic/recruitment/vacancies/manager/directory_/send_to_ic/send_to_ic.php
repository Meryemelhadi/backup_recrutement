...
class recruitment_vacancies_manager_directory__send_to_ic_send_to_ic extends NxPage
{
	function recruitment_vacancies_manager_directory__send_to_ic_send_to_ic($props,&$parentDesc,$aspect)
	{
