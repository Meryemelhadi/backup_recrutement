...
class recruitment_vacancies_manager_directory__rated_candidate_rated_candidate extends NxPage
{
	function recruitment_vacancies_manager_directory__rated_candidate_rated_candidate($props,&$parentDesc,$aspect)
	{
	...
	function run()
	{
					...
					$this->setProperty('search.url',$_SERVER["PHP_SELF"].'?nxo=rated_candidate&amp;nxs=&amp;vacancy_oid='.$this->getProperty("vacancy_oid","").'&amp;oid='.$this->getProperty("vacancy_oid",""));
					...
					$this->getRecords('handler:recruitment.candidates.rated@recruitment','candidates_rated.records','db',false,$searchData,null);
					$this->setProperty('candidate_record.url',$_SERVER["PHP_SELF"].'?nxo='.$this->getProperty("app.operation","").'&amp;nxs=rated_record&amp;vacancy_oid='.$this->getProperty("vacancy_oid",""));
					$this->runView('/recruitment/vacancies/manager/directory__rated_candidate',array(
						'fmethod' => 'toHTML',
