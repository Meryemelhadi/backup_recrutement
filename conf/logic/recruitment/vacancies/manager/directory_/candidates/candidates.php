...
class recruitment_vacancies_manager_directory__candidates_candidates extends NxPage
{
	function recruitment_vacancies_manager_directory__candidates_candidates($props,&$parentDesc,$aspect)
	{
	...
	function run()
	{
					...
					$this->setProperty('search.url',$_SERVER["PHP_SELF"].'?nxo=candidates_list&amp;nxs=&amp;vacancy_oid='.$this->getProperty("vacancy_oid","").'&amp;oid='.$this->getProperty("vacancy_oid",""));
					...
					$this->setProperty('add_interview.url',$_SERVER["PHP_SELF"].'?nxo=candidate_add_interview&amp;nxs=&amp;vacancy_oid='.$this->getProperty("vacancy_oid",""));
					...
					$this->getRecords('handler:recruitment.candidates.selected@recruitment','candidates_selected.records','db',false,$searchData,null);
					$this->setProperty('candidate_record.url',$_SERVER["PHP_SELF"].'?nxo='.$this->getProperty("app.operation","").'&amp;nxs=candidate_record&amp;vacancy_oid='.$this->getProperty("vacancy_oid",""));
					$this->setProperty('short_list_record.url',$_SERVER["PHP_SELF"].'?nxo=shorts_list&amp;nxs=short_list_record&amp;vacancy_oid='.$this->getProperty("vacancy_oid",""));
					$this->runView('/recruitment/vacancies/manager/directory__candidates',array(
						'fmethod' => 'toHTML',
