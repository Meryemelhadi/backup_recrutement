...
class recruitment_vacancies_manager_directory__add_interview_add_interview extends NxPage
{
	function recruitment_vacancies_manager_directory__add_interview_add_interview($props,&$parentDesc,$aspect)
	{
