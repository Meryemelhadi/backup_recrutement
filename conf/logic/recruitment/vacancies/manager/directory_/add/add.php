...
class recruitment_vacancies_manager_directory__add_add extends NxPage
{
	function recruitment_vacancies_manager_directory__add_add($props,&$parentDesc,$aspect)
	{
	...
	function run()
	{
					...
					$this->runView('/recruitment/vacancies/manager/directory__add',array(
						'fmethod' => 'toForm',
