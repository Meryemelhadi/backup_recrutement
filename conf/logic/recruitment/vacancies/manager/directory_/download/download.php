...
class recruitment_vacancies_manager_directory__download_download extends NxPage
{
	function recruitment_vacancies_manager_directory__download_download($props,&$parentDesc,$aspect)
	{
