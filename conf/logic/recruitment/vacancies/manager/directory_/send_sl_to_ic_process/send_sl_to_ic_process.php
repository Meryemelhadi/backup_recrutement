...
class recruitment_vacancies_manager_directory__send_sl_to_ic_process_send_sl_to_ic_process extends NxPage
{
	function recruitment_vacancies_manager_directory__send_sl_to_ic_process_send_sl_to_ic_process($props,&$parentDesc,$aspect)
	{
