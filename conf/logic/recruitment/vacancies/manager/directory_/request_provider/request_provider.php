...
class recruitment_vacancies_manager_directory__request_provider_request_provider extends NxPage
{
	function recruitment_vacancies_manager_directory__request_provider_request_provider($props,&$parentDesc,$aspect)
	{
	...
	function run()
	{
					...
					$this->setProperty("vacancy_oid",(isset($_REQUEST["vacancy_oid"])?$_REQUEST["vacancy_oid"]:""));
					$this->getRecord('rct_vacancy_provider.add@recruitment','page.record','empty',false,null,null);
					$this->setProperty("previous_op_label",$this->getString("back_to_providers"));
					...
					$this->setProperty('submit.url',$_SERVER["PHP_SELF"].'?nxo=request_provider_process&amp;nxs=');
					$this->runView('/recruitment/vacancies/manager/directory__provider_add',array(
						'fmethod' => 'toHTML',
