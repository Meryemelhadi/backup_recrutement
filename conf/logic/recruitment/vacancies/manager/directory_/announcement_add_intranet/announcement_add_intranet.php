...
class recruitment_vacancies_manager_directory__announcement_add_intranet_announcement_add_intranet extends NxPage
{
	function recruitment_vacancies_manager_directory__announcement_add_intranet_announcement_add_intranet($props,&$parentDesc,$aspect)
	{
	...
	function run()
	{
					...
					$this->setProperty("vacancy_oid",(isset($_REQUEST["oid"])?$_REQUEST["oid"]:""));
					$this->getRecord('journal.add_intranet@recruitment','page.record','empty',false,null,null);
					...
					$this->runView('/recruitment/vacancies/manager/directory__announcement_add',array(
						'fmethod' => 'toHTML',
