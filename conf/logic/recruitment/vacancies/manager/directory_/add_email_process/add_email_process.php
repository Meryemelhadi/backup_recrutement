...
class recruitment_vacancies_manager_directory__add_email_process_add_email_process extends NxPage
{
	function recruitment_vacancies_manager_directory__add_email_process_add_email_process($props,&$parentDesc,$aspect)
	{
