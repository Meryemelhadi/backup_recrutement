...
class recruitment_candidates_directory__interview_download_interview_download_interviewers extends NxPage
{
	function recruitment_candidates_directory__interview_download_interview_download_interviewers($props,&$parentDesc,$aspect)
	{
