...
class recruitment_candidates_directory__add_interview_synthesis_process_add_interview_synthesis_process extends NxPage
{
	...
	function run()
	{
					...
					$this->putRecord(
						$this->getRecord('rct_interview_synthesis.add@recruitment','page.records','post',false,null,null),'rct_interview_synthesis.add_process@recruitment','insert','db','Object',null);
		return true;
	}
}
?>