...
class recruitment_admin_manage_providers__edit_ajax_input extends NxPage
{
	function recruitment_admin_manage_providers__edit_ajax_input($props,&$parentDesc,$aspect)
	{
	...
	function run()
	{
					...
					$this->runView('/recruitment/admin/manage_providers__edit',array(
						'fmethod' => 'toForm',
