...
class recruitment_admin_manage_email_samples__details_input extends NxPage
{
	function recruitment_admin_manage_email_samples__details_input($props,&$parentDesc,$aspect)
	{
	...
	function run()
	{
					...
					$this->runView('/recruitment/admin/manage_email_samples__show',array(
						'fmethod' => 'toHTML',
