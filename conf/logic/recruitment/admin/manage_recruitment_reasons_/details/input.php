...
class recruitment_admin_manage_recruitment_reasons__details_input extends NxPage
{
	function recruitment_admin_manage_recruitment_reasons__details_input($props,&$parentDesc,$aspect)
	{
	...
	function run()
	{
					...
					$this->runView('/recruitment/admin/manage_recruitment_reasons__show',array(
						'fmethod' => 'toHTML',
