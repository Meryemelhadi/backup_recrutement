...
class add_interview_synthesis_add_interview_synthesis extends NxPage
{
	function add_interview_synthesis_add_interview_synthesis($props,&$parentDesc,$aspect)
	{
	...
	function run()
	{
							...
							$this->runView('_interview_synthesis_add',array(
								'fmethod' => 'toHTML',
