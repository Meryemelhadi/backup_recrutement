...
class recruitment_providers_recruitment_providers extends NxPage
{
	function recruitment_providers_recruitment_providers($props,&$parentDesc,$aspect)
	{
	...
	function run()
	{
							...
							$this->runView('_recruitment_providers',array(
								'fmethod' => 'toHTML',
