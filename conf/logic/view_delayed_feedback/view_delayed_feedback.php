...
class view_delayed_feedback_view_delayed_feedback extends NxPage
{
	function view_delayed_feedback_view_delayed_feedback($props,&$parentDesc,$aspect)
	{
	...
	function run()
	{
							...
							$this->runView('_feedback_view',array(
								'fmethod' => 'toHTML',
