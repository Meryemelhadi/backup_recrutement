...
class announcement_add_internet_announcement_add_internet extends NxPage
{
	function announcement_add_internet_announcement_add_internet($props,&$parentDesc,$aspect)
	{
	...
	function run()
	{
							...
							$this->runView('_announcement_add_internet',array(
								'fmethod' => 'toHTML',
