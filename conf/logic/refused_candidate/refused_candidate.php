...
class refused_candidate_refused_candidate extends NxPage
{
	function refused_candidate_refused_candidate($props,&$parentDesc,$aspect)
	{
	...
	function run()
	{
							...
							$this->runView('_refused_candidate',array(
								'fmethod' => 'toHTML',
