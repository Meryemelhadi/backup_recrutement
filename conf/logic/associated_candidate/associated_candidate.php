...
class associated_candidate_associated_candidate extends NxPage
{
	function associated_candidate_associated_candidate($props,&$parentDesc,$aspect)
	{
	...
	function run()
	{
							...
							$this->runView('_associated_candidate',array(
								'fmethod' => 'toHTML',
