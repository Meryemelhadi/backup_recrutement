...
class pdf_interview_synthesis_pdf_interview_synthesis extends NxPage
{
	function pdf_interview_synthesis_pdf_interview_synthesis($props,&$parentDesc,$aspect)
	{
	...
	function run()
	{
							...
							$this->runView('_interview_synthesis_pdf',array(
								'fmethod' => 'toHTML',
